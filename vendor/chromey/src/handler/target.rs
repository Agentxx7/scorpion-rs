...
use chromiumoxide_cdp::cdp::browser_protocol::{
    ...
    target::{
        AttachToTargetParams, EventAttachedToTarget, EventDetachedFromTarget, SessionId,
    ...
    pub fn on_event(&mut self, event: CdpEventMessage) {
        ...
        match &params {
            ...
            CdpEvent::TargetAttachedToTarget(ev) => {
                self.queued_events
                    .push_back(TargetEvent::AttachedToTarget(ev.clone()));
            ...
            CdpEvent::TargetDetachedFromTarget(ev) => self
                .queued_events
                .push_back(TargetEvent::DetachedFromTarget(ev.clone())),
...
pub(crate) enum TargetEvent {
    ...
    BytesConsumed(u64),
    /// A flattened child target was attached through this target.
    AttachedToTarget(Box<EventAttachedToTarget>),
    /// A flattened child target session was detached.
